...
function shallow$1$4(objA, objB) {
...
var Handle = (0, import_react.forwardRef)(({ type = "source", position = Position.Top, isValidConnection, isConnectable = true, isConnectableStart = true, isConnectableEnd = true, id, onConnect, children, className, onMouseDown, onTouchStart, ...rest }, ref) => {
	...
	const { connectOnClick, noPanClassName } = useStore(selector$f, shallow$1$4);
	const { connecting, clickConnecting } = useStore(connectingSelector(nodeId, handleId, type), shallow$1$4);
...
function areEqual(a, b) {
	return shallow$1$4(a.selectedNodes.map(selectId), b.selectedNodes.map(selectId)) && shallow$1$4(a.selectedEdges.map(selectId), b.selectedEdges.map(selectId));
}
...
var StoreUpdater = ({ nodes, edges, defaultNodes, defaultEdges, onConnect, onConnectStart, onConnectEnd, onClickConnectStart, onClickConnectEnd, nodesDraggable, nodesConnectable, nodesFocusable, edgesFocusable, edgesUpdatable, elevateNodesOnSelect, minZoom, maxZoom, nodeExtent, onNodesChange, onEdgesChange, elementsSelectable, connectionMode, snapGrid, snapToGrid, translateExtent, connectOnClick, defaultEdgeOptions, fitView, fitViewOptions, onNodesDelete, onEdgesDelete, onNodeDrag, onNodeDragStart, onNodeDragStop, onSelectionDrag, onSelectionDragStart, onSelectionDragStop, noPanClassName, nodeOrigin, rfId, autoPanOnConnect, autoPanOnNodeDrag, onError, connectionRadius, isValidConnection, nodeDragThreshold }) => {
	const { setNodes, setEdges, setDefaultNodesAndEdges, setMinZoom, setMaxZoom, setTranslateExtent, setNodeExtent, reset } = useStore(selector$d, shallow$1$4);
	const store = useStoreApi();
	(0, import_react.useEffect)(() => {
...
var useViewportHelper = () => {
	const store = useStoreApi();
	const { d3Zoom, d3Selection } = useStore(selector$b, shallow$1$4);
	return (0, import_react.useMemo)(() => {
...
var ZoomPane = ({ onMove, onMoveStart, onMoveEnd, onPaneContextMenu, zoomOnScroll = true, zoomOnPinch = true, panOnScroll = false, panOnScrollSpeed = .5, panOnScrollMode = PanOnScrollMode.Free, zoomOnDoubleClick = true, elementsSelectable, panOnDrag = true, defaultViewport, translateExtent, minZoom, maxZoom, zoomActivationKeyCode, preventScrolling = true, children, noWheelClassName, noPanClassName }) => {
	...
	const { d3Zoom, d3Selection, d3ZoomHandler, userSelectionActive } = useStore(selector$a, shallow$1$4);
...
function UserSelection() {
	const { userSelectionActive, userSelectionRect } = useStore(selector$9, shallow$1$4);
...
var Pane = (0, import_react.memo)(({ isSelecting, selectionMode = SelectionMode.Full, panOnDrag, onSelectionStart, onSelectionEnd, onPaneClick, onPaneContextMenu, onPaneScroll, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, children }) => {
	...
	const { userSelectionActive, elementsSelectable, dragging } = useStore(selector$8, shallow$1$4);
...
function NodesSelection({ onSelectionContextMenu, noPanClassName, disableKeyboardA11y }) {
	const store = useStoreApi();
	const { width, height, x: left, y: top, transformString, userSelectionActive } = useStore(selector$7, shallow$1$4);
	const updatePositions = useUpdateNodePositions();
	const nodeRef = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
...
var NodeRenderer = (props) => {
	const { nodesDraggable, nodesConnectable, nodesFocusable, elementsSelectable, updateNodeDimensions, onError } = useStore(selector$5, shallow$1$4);
...
var EdgeRenderer = ({ defaultMarkerColor, onlyRenderVisibleElements, elevateEdgesOnSelect, rfId, edgeTypes, noPanClassName, onEdgeContextMenu, onEdgeMouseEnter, onEdgeMouseMove, onEdgeMouseLeave, onEdgeClick, onEdgeDoubleClick, onReconnect, onReconnectStart, onReconnectEnd, reconnectRadius, children, disableKeyboardA11y }) => {
	const { edgesFocusable, edgesUpdatable, elementsSelectable, width, height, connectionMode, nodeInternals, onError } = useStore(selector$4, shallow$1$4);
...
function ConnectionLineWrapper({ containerStyle, style, type, component }) {
	const { nodeId, handleType, nodesConnectable, width, height, connectionStatus } = useStore(selector$2$1, shallow$1$4);
	...
	return (0, import_react.useMemo)(() => {
		{
			...
			if (shallow$1$4(typesKeysRef.current, typeKeys)) store.getState().onError?.("002", errorMessages["error002"]());
...
function useNodes() {
	return useStore(nodesSelector, shallow$1$4);
}
var edgesSelector = (state) => state.edges;
function useEdges() {
	return useStore(edgesSelector, shallow$1$4);
}
...
function useViewport() {
	return useStore(viewportSelector, shallow$1$4);
}
...
//#endregion
//#region node_modules/@reactflow/minimap/node_modules/zustand/esm/shallow.mjs
function shallow$1$3(objA, objB) {
	if (Object.is(objA, objB)) return true;
	if (typeof objA !== "object" || objA === null || typeof objB !== "object" || objB === null) return false;
	if (objA instanceof Map && objB instanceof Map) {
		if (objA.size !== objB.size) return false;
...
function MiniMapNodes({ nodeStrokeColor = "transparent", nodeColor = "#e2e2e2", nodeClassName = "", nodeBorderRadius = 5, nodeStrokeWidth = 2, nodeComponent: NodeComponent = MiniMapNode$1, onClick }) {
	const nodes = useStore(selectorNodes, shallow$1$3);
...
function MiniMap({ style, className, nodeStrokeColor = "transparent", nodeColor = "#e2e2e2", nodeClassName = "", nodeBorderRadius = 5, nodeStrokeWidth = 2, nodeComponent, maskColor = "rgb(240, 240, 240, 0.6)", maskStrokeColor = "none", maskStrokeWidth = 1, position = "bottom-right", onClick, onNodeClick, pannable = false, zoomable = false, ariaLabel = "React Flow mini map", inversePan = false, zoomStep = 10, offsetScale = 5 }) {
	...
	const { boundingRect, viewBB, rfId } = useStore(selector$3, shallow$1$3);
...
var Controls = ({ style, showZoom = true, showFitView = true, showInteractive = true, fitViewOptions, onZoomIn, onZoomOut, onFitView, onInteractiveChange, className, children, position = "bottom-left" }) => {
	...
	const { isInteractive, minZoomReached, maxZoomReached } = useStore(selector$2, shallow$1$2);
...
function Background({ id, variant = BackgroundVariant.Dots, gap = 20, size, lineWidth = 1, offset = 2, color, style, className }) {
	...
	const { transform, patternId } = useStore(selector$1, shallow$1$1);
...
//#endregion
//#region node_modules/@reactflow/node-toolbar/node_modules/zustand/esm/shallow.mjs
